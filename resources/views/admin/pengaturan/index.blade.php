...
$(document).ready(function() {
    ...
    $("#saveData").submit(function (e) {
        ...
        const errorCallback = function (error) {
            setButtonLoadingState("#saveData .btn.btn-primary", false);
            handleValidationErrors(error, "saveData", ["nama", "email", "password", "confirm_password"]);
        };
    ...
    $("#updateData").submit(function (e) {
        ...
        const errorCallback = function (error) {
            setButtonLoadingState("#updateData .btn.btn-primary", false);
            handleValidationErrors(error, "updateData", ["nama", "email", "password", "confirm_password"]);
        };
